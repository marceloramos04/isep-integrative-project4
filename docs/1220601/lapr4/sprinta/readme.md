# 1220601 - Hugo Pais - Sprint A - Self Assessment
...
Since there isn't still any code to analyze, the justification for this level is based on the planning and technical documentation. The planning and technical documentation are well done, with a good justification of the process followed/applied. The application of good practices and techniques is exemplary.
...
The team used the repository frequently, with significant messages and a good connection to issues/tasks. The task/issue management boards were used correctly.
...
The team worked together in the development of the project, with the division of tasks and the resolution of problems that arose during the development. The team was able to work together to solve the problems that arose during the development of the project.
...
Without the integration of any component, it is impossible to demonstrate the integration of the system.
...
The requirements were met in full, and the interpretation/analysis of the problem was correctly justified. The acceptance criteria were well defined and reflected in the tests.