# 1220601 - Hugo Pais - Sprint B - Self Assessment
...
The engineering process is globally correct, with some small flaws in documentation and some activities with errors or missing. There may be some inconsistency between code and design.
...
There might be some inconsistencies and/or unnecessary coupling between components/functionality.
...
The requirements were not met in full, and the interpretation/analysis of the problem was correctly justified. The acceptance criteria were well defined and reflected in the tests.