# 1221636 - Dephane Cabral - Sprint C - Self Assessment
...
The engineering process is acceptable, with just some minor flaws in it and maybe some missing documentation. And there may be some inconsistency between code and design.
...
The team used the repository very frequently, and tried not to miss with any smart commits
## Team Work
...
The entire team worked together in the development of the project.
...
The requirements were not completely fulfilled, yet the problem's interpretation and analysis were properly explained.